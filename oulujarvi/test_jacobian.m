migration('1_Lake_Oulujarvi.mat','oulujarvi.model');
results = atns('oulujarvi.model','days_per_year',90,'years',40,'steps_per_day',1);
results.plot();
sddsa
B = results.Bmajor;
%Blast = results.Bmajor(:,end);
%extinct = find(B<1);
%save(targetfile,'B','Blast','extinct');
%%        end
%end
%end
