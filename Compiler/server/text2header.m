...
for i=1:length(request_lines)
    ...
    switch(lower(type))
        ...
        case 'options'
            header.Options.Filename=request_words{i}{2};
            header.Options.Protocol=request_words{i}{3};
        case 'host:'
...
if(isfield(header,'ContentLength'))
    ...
    switch (header.ContentType.Type)
        case {'application/x-www-form-urlencoded',''}
            ...
            %    header.Content.(words2{1})=urldecode(words2{2});
            %end
