...
%--------------------------------------------------------------------------
% Renamed & slight modifications by mvesterinen Feb 21 2018
% todo: comments and changes

function [web_mx,n_new,r_new,c_new,c]=CreateWeb_ATN(num_nodes,connectance,n,n_old,r_old,c_old,orig_index,givediet)
