function dXdt = atn_ode(~,X,Data,Options)
% ----------------------------------------------------------------------- %
% ----------------------------- PARAMETERS ------------------------------ %
% ----------------------------------------------------------------------- %
...
%     - lFishConsumption ...
%     - lFishFishing,0);
% gFishBiomassAvailable = invest.*gFishConsumption.*P_mat;
% gFishBiomassAvailable = 1*gFishConsumption;
lFish = lFishMaintenance + lFishConsumption + lFishFishing;
% fGL = min(gFishConsumption./lFish,1);
sc = 1;
% gFishBiomassAvailable = sc*fGL.*gFishConsumption;

R1 = sc*gFishConsumption./lFish.*(gFishConsumption <= lFish).*gFishConsumption;
R2 = sc*(gFishConsumption > lFish).*(2*gFishConsumption-lFish);
...
% lFishReproduction = gFishBiomassAvailable;
lFishReproduction = invest.*gFishBiomassAvailable.*P_mat;
