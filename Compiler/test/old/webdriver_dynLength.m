...
load('Data\1_LakeConstance_dynLength.mat','Data')
...
% Data.gear = Gear('fyke net', propRelease);
...
ResultOptions.File = sprintf('results_dynLength.txt');
...
for cycle = cycles
    ...
    [~,X] = ode23(@(t,X)atn_ode_dynLength(t,X,ODEData,Options), ...
        tspan,Xinit,odeopt);
