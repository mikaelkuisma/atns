...
% %%%
% %%% fixing the issue where exudation only happened when algae gained biomass
% gProducerNetGrowth = ProducerGrossGrowth;
% 
% % PRODUCER loss to exudation
% lProducerExudation = s.*bProducerGuilds;
% %%%
% %%%
...
lPOCConsumption = lossVEC(GuildInfo.iFoodGuilds == GuildInfo.iPOC) / 0.45;
if isempty(lPOCConsumption)
    lPOCConsumption = 0;
end
