...
load(['Data\' DataFile '.mat'], 'Data')

%
%%% Save network properties to file
adjacencyMatrixToFile(sprintf('%s%s_%s.txt', ResultOptions.Directory, DataFile, 'links'), Data.adjacencyMatrix)
guildLabelsToFile(sprintf('%s%s_%s.txt', ResultOptions.Directory, DataFile, 'labels'), Data.Guilds)
guildColorsToFile(sprintf('%s%s_%s.txt', ResultOptions.Directory, DataFile, 'colors'), Data.Guilds)
trophicLevelsToFile(sprintf('%s%s_%s.txt', ResultOptions.Directory, DataFile, 'TL'), Data.adjacencyMatrix)
