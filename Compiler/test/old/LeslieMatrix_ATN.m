...
function [aging_table,fecund_table]= LeslieMatrix_ATN(leslie,newwebsize,N_stages,is_split,species)
attach(leslie); 
...
%lifehistory matrix for it.  Find correlations from Hutchings, J. A., Myers, R. A., García, V. B., Lucifora, L. O., & Kuparinen, A. (2012). 
%Life-history correlates of extinction risk and recovery potential. Ecological Applications, 22(4), 1061–1067. 
%Retrieved from http://www.esajournals.org/doi/abs/10.1890/11-1313.1
